...
public class ActivityFrizider1 extends AppCompatActivity {
    @BindView(R.id.kolicina) EditText kolicina;
    @BindView(R.id.ukupna_cena) TextView ukupna;
    public int rez = 40000;
    @Inject Realm realm;
    String naziv = "Frizider 1";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getSupportActionBar().hide();
        setContentView(R.layout.activity_frizider1);
    ...
    public void posalji() {
       // String rez2 = String.valueOf(rez);
//        Toast.makeText(this, rez2, Toast.LENGTH_SHORT).show();
